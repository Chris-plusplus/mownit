...
int main() {
	for (auto&& dir : {
		"interpolation_images/lagrange_newton/uniform/",
		"interpolation_images/lagrange_newton/chebyshev/",
		"interpolation_images/lagrange_newton/error_uniform/",
		"interpolation_images/lagrange_newton/error_chebyshev/",
		"interpolation_results/lagrange_newton/"
		 }) {
	...
	auto max_abs_file = std::ofstream("interpolation_results/lagrange_newton/__max_abs.txt");
	auto sum_squared_file = std::ofstream("interpolation_results/lagrange_newton/__sum_squared.txt");
...
#if not NOFILE
		std::ofstream result_file("interpolation_results/lagrange_newton/result_" + std::to_string(nodes_count) + ".txt");
...
#if not NOFILE
		std::ofstream error_file("interpolation_results/lagrange_newton/error_" + std::to_string(nodes_count) + ".txt");
...
#pragma endregion
		...
		cv::imwrite("interpolation_images/lagrange_newton/uniform/" + std::to_string(nodes_count) + ".png", axes_uniform.render(window_height, window_width));
		cv::imwrite("interpolation_images/lagrange_newton/chebyshev/" + std::to_string(nodes_count) + ".png", axes_chebyshev.render(window_height, window_width));
		cv::imwrite("interpolation_images/lagrange_newton/error_uniform/" + std::to_string(nodes_count) + ".png", axes_error_uniform.render(window_height, window_width));
		cv::imwrite("interpolation_images/lagrange_newton/error_chebyshev/" + std::to_string(nodes_count) + ".png", axes_error_chebyshev.render(window_height, window_width));
	...
	cv::imwrite("interpolation_images/lagrange_newton/__max_abs.png", axes_max_abs.render(window_height, window_width));
	cv::imwrite("interpolation_images/lagrange_newton/__sum_squared.png", axes_sum_squared.render(window_height, window_width));
