...
auto window_height = 500;
auto window_width = 750;
...
int main() {
	...
	auto max_abs_file = std::ofstream("approximation_results/__ls_max_abs.txt");
	auto max_abs_log_file = std::ofstream("approximation_results/__ls_max_abs_log.txt");
	auto sum_squared_file = std::ofstream("approximation_results/__ls_sum_squared.txt");
	auto sum_squared_log_file = std::ofstream("approximation_results/__ls_sum_squared_log.txt");
...
#pragma endregion
	...
	auto ls_max_abs_log_dat = std::ofstream("approximation_results/__ls_max_abs_log.dat");
	auto ls_sum_squared_log_dat = std::ofstream("approximation_results/__ls_sum_squared_log.dat");
